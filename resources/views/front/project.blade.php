...
<main>
    <div class="slider">
        ...
        <a class="bulb"><i class="fas fa-lightbulb-slash"></i></a>
    </div>
...
<script>
    $('.bulb').click(function () {
        if($('.slide.projec').hasClass('close')){
            ...
            $('.fa-lightbulb-slash').addClass('fa-lightbulb')
            $('.fa-lightbulb').removeClass('fa-lightbulb-slash')
        }
        else{
            $('.slide.projec').addClass('close')
            $('.fa-lightbulb').addClass('fa-lightbulb-slash')
            $('.fa-lightbulb-slash').removeClass('fa-lightbulb')
        }
    })
</script>
<script>
